...
export const reservedWords = {
  es2015: makePredicate(RESERVED_WORDS.es2015),
  strict: makePredicate(RESERVED_WORDS.strict),
  strictBind: makePredicate(RESERVED_WORDS.strictBind),
  tacoscript: makePredicate(RESERVED_WORDS.tacoscript)
}

export const isKeyword = makePredicate(RESERVED_WORDS.keywords);

import {keywords} from "../tokenizer/types";
for (let keyword in keywords) {
  if (!isKeyword(keyword) && !reservedWords.es2015(keyword) &&
  !reservedWords.strict(keyword) && !reservedWords.strictBind(keyword)) {
    RESERVED_WORDS.tacoscript.push(keyword);
  }
}
